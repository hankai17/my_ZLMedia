...
int main(int argc,char *argv[]) {
    ...
    //return domain("http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8", "http://127.0.0.1/live/m3u8_push");
    //auto urlList = {"rtsp://admin:admin123@192.168.1.64:554/cam/realmonitor?channel=1&subtype=1"
    //auto urlList = {"http://ivi.bupt.edu.cn/hls/cctv1hd.m3u8"
            auto urlList = {"http://devimages.apple.com/iphone/samples/bipbop/bipbopall.m3u8"
            //rtsp链接支持输入用户名密码
